...
jQuery(document).ready(function ($) {   
   ...
   if (typeof window.history.pushState == 'function') { 
      ...
      // $.fn.almSEO
      // triggered from main ajax-load-more.js file.
      $.fn.almSEO = function(alm){
         ...
         // Preloaded fix coming soon  
         if(almSEO.preloaded === 'true'){ // If preload, then start on page 0
            start = 0;
            page = page + 1;
         }
      ...
      */
      ...
      almSEO.getCurrentPageTop = function(page){
         ...
         if(objs.length){
            ...
            if(almSEO.scroll === 'true') almSEO.scrollToPage(objSelected);
