    ...
    <div id="mobile-share" class="social-share large-2 small-12 column">
      <div class="inner">
        ...
        <ul>
          ...
          <li><a href="https://twitter.com/share?url=<?php echo get_permalink(); ?>&amp;via=carl0s_&amp;text=<?php echo str_replace('<br />',' ',get_the_title()); ?>" target="_blank" class="icon-twitter"></a> </li>
        </ul>
      </div>
    </div>
  </div>
